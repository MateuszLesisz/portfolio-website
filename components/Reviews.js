    ...
    return (
        <SectionWrapper>
            ...
            <div className="relative w-full">
                {data.length !== count ? (
                    <div className="absolute bottom-0 w-full h-full bg-gradient-to-t from-white/80 dark:from-black/80 to-transparent
                flex justify-center items-end">
                        <button className="h-[45px] bg-violet-600 text-white rounded-lg font-medium text-base capitalize
                    px-4" onClick={() => setCount(count + 6)}>show more
                        </button>
                    </div>
                ) : (
                    ""
